...
names(myseq)<- (paste0(names(finalGR),".",seqnames(finalGR),"_",row.names(as.data.frame(finalGR))))
...
names(myseq)<- (paste0(names(ultimeGR),".",seqnames(ultimeGR),"_",row.names(as.data.frame(ultimeGR))))
