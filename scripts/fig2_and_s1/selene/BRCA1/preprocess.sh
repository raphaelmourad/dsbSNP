name='GSM935377_BRCA1'
size="2000"

#bgzip -d wgEncodeAwgTfbsUtaGm12878CtcfUniPk.narrowPeak.gz
Rscript --vanilla get_fasta.R  GSM935377_hg19_wgEncodeSydhTfbsGm12878Brca1a300IggmusPk.narrowPeak ${name} ${size}
...
sed -i "s/$/\tBRCA1/" hg19_blacklisted/$name.cut.bed
echo "sed ok"
...
sed -i "s/$/\tBRCA1/" hg19_blacklisted_400bestAsiSI_masked/$name.cut.bed
echo "sed ok"
